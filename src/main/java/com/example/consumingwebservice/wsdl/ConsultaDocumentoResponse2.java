...
/**
 * <p>Clase Java para ConsultaDocumentoResponse complex type.
 * 
...
@XmlType(name = "ConsultaDocumentoResponse", namespace = "http://response.ws.dte.azurian.com", propOrder = {
    "codigoRespuesta",
    "descripcion"
})
public class ConsultaDocumentoResponse2 {
